...
<div class="main-content mt-5" id="mainContent">
    ...
    <a href="<?= base_url('/RiwayatPengiriman/') ?>" class="m-2">&laquo; Kembali</a>
    <hr>
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
        ...
        <?php if ($detailpengirim['status'] === 'Delivered Successfully') : ?>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <h5>Di Terima Oleh</h5>
                </div>
                <div class="col-lg-5">
                    <p>: <?= $detailpengirim['nama_penerima'] ?></p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-5">
                    <p>: <img src="<?= base_url('/assets/images/bukti/' . $detailpengirim['foto_penerima']) ?>" alt="" width="250" height="250"></p>
                </div>
            </div>
        <?php endif ?>
